...
venue: "Introduction to R for Ecological Data Analysis -- Huntsman Marine Science Center"        # brief name of host site without address (e.g., "Euphoric State University")
address: "1 Lower Campus Rd, Saint Andrews, NB"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "45.084929,-67.080223"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
humandate: "March 19-20, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Lindsay Brin","Joey Bernard"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Fonya Irvine", "Allan Debertin"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["lindsay.brin@gmail.com","joey.bernard@ace-net.ca"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<div id="vm">
<h3>Spreadsheet Installation</h3>
